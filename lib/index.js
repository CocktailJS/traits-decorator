...
function mixins() {
    for (var _len2 = arguments.length, mixinsList = Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
        mixinsList[_key2] = arguments[_key2];
    }

    return function (target) {
        Object.assign.apply(Object, [target.prototype].concat(mixinsList));
    };
}
