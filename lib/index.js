...
function as() {
    ...
    var options = arguments[0] === undefined ? { alias: {}, excludes: [] } : arguments[0];
    var descriptor = _asDescriptor.call(this);
    var _alias = options.alias;
    var _excludesList = options.excludes;

    (_ref2 = (_context = alias.call(descriptor, _alias), excludes)).call.apply(_ref2, [_context].concat(_toConsumableArray(_excludesList)));
